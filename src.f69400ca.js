...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"minimatica/Console.ts":[function(require,module,exports) {
"use strict";
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"components/minimatica_text/MinimaticaText.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/minimatica_text/MinimaticaText.tsx":[function(require,module,exports) {
"use strict";
...
require("./MinimaticaText.sass"); // onChange={(event) => this.props.onSourceEdit("Hello")}


var MinimaticaText =
/** @class */
function (_super) {
  __extends(MinimaticaText, _super);

  function MinimaticaText() {
  ...
  MinimaticaText.prototype.render = function () {
    var Style = {
      lineHeight: "20px",
  ...
  return MinimaticaText;
}(React.Component);

exports["default"] = MinimaticaText;
},{"react":"../node_modules/react/index.js","./MinimaticaText.sass":"components/minimatica_text/MinimaticaText.sass"}],"components/minimatica_console/MinimaticaConsole.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/minimatica_console/MinimaticaConsole.tsx":[function(require,module,exports) {
"use strict";
...
require("./MinimaticaConsole.sass");

var MinimaticaConsole =
/** @class */
function (_super) {
  __extends(MinimaticaConsole, _super);

  function MinimaticaConsole(props) {
    var _this = _super.call(this, props) || this;

    _this.ConsoleEntry = function (obj) {
      return React.createElement("li", {
        key: (Math.random() * 100).toString()
      }, ">  " + obj.toString());
    };

    props.console.onLog = function (obj) {
      _this.forceUpdate();
    };
  ...
  MinimaticaConsole.prototype.shouldComponentUpdate = function (nextProps, nextState, nextContext) {
    return this.props.console.messages !== nextProps.console.messages;
  };

  MinimaticaConsole.prototype.render = function () {
  ...
  return MinimaticaConsole;
}(React.Component);

exports["default"] = MinimaticaConsole;
},{"react":"../node_modules/react/index.js","./MinimaticaConsole.sass":"components/minimatica_console/MinimaticaConsole.sass"}],"minimatica/Scanner.ts":[function(require,module,exports) {
"use strict";
...
(function (Token) {
  Token["Var"] = "var";
  Token["Assignment"] = "ass";
  Token["LeftPar"] = "lpar";
  Token["RightPar"] = "rpar";
  Token["Comma"] = "comma";
  Token["CaptureBegin"] = "capbeg";
  Token["CaptureEnd"] = "capend";
  Token["GenericBegin"] = "genbeg";
  Token["GenericEnd"] = "genend";
  Token["StatementTerminator"] = "terminator";
  Token["LambdaArrow"] = "arw";
  Token["Number"] = "num";
  Token["Identifier"] = "ident";
  Token["Exponential"] = "exp";
  Token["Multiplication"] = "mult";
  Token["Division"] = "div";
  Token["Addition"] = "add";
  Token["Subtraction"] = "sub";
  Token["Modulo"] = "mod";
  Token["EndOfFile"] = "eof";
  Token["Error"] = "error";
...
function () {
   ...
   */
  function Scanner(sourceText, console) {
    this._state = {
      currentChar: '',
      currentPosition: {
        absoluteIndex: 0,
  ...
  Scanner.prototype.readToken = function () {
    // skip whitespace
    while (this._state.currentChar === ' ' || this._state.currentChar === Scanner.TAB || this._state.currentChar === '\n') {
      this.readChar();
    }
    ...
    switch (this._state.currentChar) {
      ...
      case ':':
        this.readChar(); // @ts-ignore "always false" bla bla
  ...
  Scanner.prototype.lookAhead = function () {
    ...
    // x tokens.
    var la = Token.Error;
    var storedState = this.freezeState();
    this.readToken();
  ...
  Scanner.prototype.freezeState = function () {
    var frozenTextPosition = {
  ...
  Scanner.prototype.getNumber = function () {
    var value = parseFloat(this._state.literalBuffer);
...
},{}],"minimatica/SymbolTable.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  SymbolTable.prototype.valueOf = function (name) {
  ...
  SymbolTable.prototype.declare = function (name) {
...
},{}],"minimatica/stdlib/Matrix.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Matrix.prototype.multiplyNum = function (num) {
    var args = this.data.slice().map(function (value) {
      return value * num;
    });
    return matrixWithDimensions(this.rows, this.columns).apply(void 0, args);
  };

  Matrix.prototype.multiplyMat = function (mat) {
    ...
    for (var row = 0; row < this.rows; ++row) {
      for (var column = 0; column < mat.columns; ++column) {
        var sum = 0;
    ...
    return matrixWithDimensions(this.rows, mat.columns).apply(void 0, args);
  };
  ...
  Matrix.prototype.toString = function () {
    ...
    for (var i = 0; i < this.rows; ++i) {
      str += this.data[i].reduce(function (acc, curr) {
        return acc + curr + ", ";
      }, "");
...
function matrixWithDimensions(rows, columns) {
  return function () {
    var values = [];
    ...
    var matr = new Matrix(rows, columns);
    matr.setValues(values);
    return matr;
  };
}

exports.matrixWithDimensions = matrixWithDimensions;

function vectorWithDimensions(rows) {
  return matrixWithDimensions(rows, 1);
}

exports.vectorWithDimensions = vectorWithDimensions;
},{}],"minimatica/stdlib/Geometry.ts":[function(require,module,exports) {
"use strict";
...
exports.tan = tan;
},{}],"minimatica/stdlib/Utilities.ts":[function(require,module,exports) {
"use strict";

exports.__esModule = true;

function bothOperandsNumbers(a, b) {
  return typeof a === "number" && typeof b === "number";
}

exports.bothOperandsNumbers = bothOperandsNumbers;
},{}],"minimatica/stdlib/Arithmetic.ts":[function(require,module,exports) {
"use strict";
...
function add(a, b) {
  if (Utilities_1.bothOperandsNumbers(a, b)) {
    return a + b;
  } else {
    return a.add(b);
  }
...
},{"./Utilities":"minimatica/stdlib/Utilities.ts"}],"minimatica/stdlib/Algebra.ts":[function(require,module,exports) {
"use strict";
...
},{}],"minimatica/StdLib.ts":[function(require,module,exports) {
"use strict";
...
var Matrix_1 = require("./stdlib/Matrix");

var Geometry_1 = require("./stdlib/Geometry");

var Arithmetic_1 = require("./stdlib/Arithmetic");

var Algebra_1 = require("./stdlib/Algebra");
...
function () {
  ...
  StdLib.defineAllInGroup = function (group, table) {
    if (StdLib[group] === undefined) {
      throw new Error("Failed to load standard library: Function group \"" + group + "\" does not exist.");
    }

    for (var _i = 0, _a = Object.keys(StdLib[group]); _i < _a.length; _i++) {
      var Func = _a[_i];
      table.define(StdLib[group][Func].name, StdLib[group][Func].f);
    }
  };

  StdLib.preloadedSymbolTable = function () {
    var table = new SymbolTable_1.SymbolTable(); // ---- FUNCTIONS ----
    // -- IO --

    StdLib.defineAllInGroup("IO", table); // -- ALGEBRA --

    StdLib.defineAllInGroup("Algebra", table); // ---- TYPES ----

    StdLib.defineAllInGroup("Types", table);
    return table;
  };

  StdLib.console = window.console;
  StdLib.Arithmetic = {
    ADD: Arithmetic_1.add,
    SUBTRACT: Arithmetic_1.subtract,
    MULTIPLY: Arithmetic_1.multiply,
    DIVIDE_BY: Arithmetic_1.dividedBy,
    MODULO: Arithmetic_1.modulo
  };
  StdLib.IO = {
    ...
    PRINT: {
      ...
      f: function f() {
        ...
        return (_a = StdLib.console).log.apply(_a, args);
      }
    }
  };
  StdLib.Algebra = {
    ...
    BINOMIAL: {
      name: "binomial",
      f: Algebra_1.binomial
    }
  };
  StdLib.Types = {
    MATRIX: {
      name: "mat",
      f: Matrix_1.matrixWithDimensions
    },
    VECTOR: {
      name: "vec",
      f: Matrix_1.vectorWithDimensions
    }
  };
  return StdLib;
}();
...
},{"./SymbolTable":"minimatica/SymbolTable.ts","./stdlib/Matrix":"minimatica/stdlib/Matrix.ts","./stdlib/Geometry":"minimatica/stdlib/Geometry.ts","./stdlib/Arithmetic":"minimatica/stdlib/Arithmetic.ts","./stdlib/Algebra":"minimatica/stdlib/Algebra.ts"}],"minimatica/stdlib/Function.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Function.prototype.apply = function (x) {
    ...
    for (var i = 0; i < this.coefficients.length; ++i) {
      var exponent = this.coefficients.length - i - 1;
  ...
  Function.prototype.derive = function () {
    var derivedCoefficients = this.coefficients.map(function (coeff, index, arr) {
      var exponent = arr.length - index - 1;
  ...
  Function.prototype.integrate = function () {
    var derivedCoefficients = this.coefficients.map(function (coeff, index, arr) {
      var exponent = arr.length - index - 1;
  ...
  Function.prototype.toString = function () {
    var polynom = "f(x)=";
    this.coefficients.forEach(function (coeff, index, arr) {
      if (coeff !== 0) {
        var exponent = arr.length - index - 1;
        ...
        if (coeff > 0) polynom += '+';else if (coeff < 0) polynom += '-';
...
},{}],"minimatica/stdlib/Callable.ts":[function(require,module,exports) {
"use strict";

exports.__esModule = true;

function asCallable(f) {
...
},{}],"minimatica/Parser.ts":[function(require,module,exports) {
"use strict";
...
var Function_1 = require("./stdlib/Function");

var Callable_1 = require("./stdlib/Callable");

var Parser =
/** @class */
function () {
  function Parser(sourceText, console) {
    this._sourceText = sourceText;

    if (console) {
      this._console = console;
      StdLib_1.StdLib.console = console;
    }

    this._success = true;
    this._scanner = new Scanner_1.Scanner(sourceText, console);
    this._symbolTable = StdLib_1.StdLib.preloadedSymbolTable();
  }
  ...
  Parser.prototype.parse = function () {
    ...
    while (!this.isToken(Scanner_1.Token.EndOfFile) && this._success) {
      if (!this.assertToken(Scanner_1.Token.StatementTerminator)) {
        return;
      }
  ...
  Parser.prototype.isToken = function (token) {
    return this._scanner.getCurrentToken() === token;
  };

  Parser.prototype.assertToken = function (token) {
  ...
  Parser.prototype.issueError = function (msg) {
    this._success = false;

    this._console.error(msg);
  };

  Parser.prototype.unexpectedToken = function () {
    this.issueError("Unexpected token \"" + this._scanner.getCurrentToken() + "\"");
  };

  Parser.prototype.notDefined = function (name) {
    this.issueError("Entity \"" + name + "\" is not defined.");
  };

  Parser.prototype.statement = function () {
    if (this.isToken(Scanner_1.Token.Var)) {
      this.consumeToken();
  ...
  Parser.prototype.variableDefinition = function () {
    var name = "";
    var param = {
      value: undefined
    };

    if (!this.assertToken(Scanner_1.Token.Identifier)) {
      return;
    }
    ...
    if (!this.assertToken(Scanner_1.Token.Assignment)) {
  ...
  Parser.prototype.expression = function (param) {
    if (this.isToken(Scanner_1.Token.CaptureBegin)) {
      this.consumeToken();
      this.lambda(param);
    } else {
      this.term(param);
  ...
  Parser.prototype.term = function (param) {
    var _a;

    var Operation = (_a = {}, _a[Scanner_1.Token.Addition] = StdLib_1.StdLib.Arithmetic.ADD, _a[Scanner_1.Token.Subtraction] = StdLib_1.StdLib.Arithmetic.SUBTRACT, _a);
    var op = undefined;
    var tmp = {
      value: 0
    };
    ...
    while (this.isToken(Scanner_1.Token.Addition) || this.isToken(Scanner_1.Token.Subtraction)) {
  ...
  Parser.prototype.functionCall = function (param) {
    var name;
    var dimensions = [];
    var newDimension = {
      value: 0
    ...
    if (f === undefined || !(typeof f === "function") && // sadly we can not check whether f's type implements "Callable"
    ...
    if (this.isToken(Scanner_1.Token.GenericBegin)) {
      this.consumeToken();
      this.number(newDimension);
      dimensions.push(newDimension.value);

      while (this.isToken(Scanner_1.Token.Comma)) {
        this.consumeToken();
        this.number(newDimension);
        dimensions.push(newDimension.value);
      }

      if (!this.assertToken(Scanner_1.Token.GenericEnd)) {
        return;
      }

      f = Callable_1.asCallable(f).apply(void 0, dimensions);
      this.consumeToken();
    }

    if (!this.assertToken(Scanner_1.Token.LeftPar)) {
      return;
    }

    this.consumeToken();

    if (!this.isToken(Scanner_1.Token.RightPar)) {
      ...
      if (!this.assertToken(Scanner_1.Token.RightPar)) {
        return;
      }
    }

    param.value = Callable_1.asCallable(f).apply(void 0, args);
    this.consumeToken();
  };

  Parser.prototype.lambda = function (param) {
    var name = ""; // only one item in capture list!!

    var localSymbols = this._symbolTable.clone();

    if (this.isToken(Scanner_1.Token.Identifier)) {
      name = this._scanner.getIdentifier();
    ...
    if (!this.assertToken(Scanner_1.Token.CaptureEnd)) {
      return;
    }

    this.consumeToken();

    if (!this.assertToken(Scanner_1.Token.LambdaArrow)) {
      return;
    }
  ...
  Parser.prototype.polynom = function (localSymbols, param) {
    var newCoefficient = {
      value: undefined
    };
    var coefficients = [];
    ...
    var applySign = function applySign(num) {
      return num;
    };

    if (this.isToken(Scanner_1.Token.Subtraction)) {
      applySign = function applySign(num) {
        return -num;
      };
    ...
    while (this.isToken(Scanner_1.Token.Addition) || this.isToken(Scanner_1.Token.Subtraction)) {
      var applySign_1 = function applySign_1(num) {
        return num;
      };

      if (this.isToken(Scanner_1.Token.Subtraction)) {
        applySign_1 = function applySign_1(num) {
          return -num;
        };
      }
      ...
      coefficients.push(applySign_1(newCoefficient.value));
      exponents.push(newExponent.value);
    }

    var maxExponent = exponents.reduce(function (acc, curr) {
      return Math.max(acc, curr);
    }, -1);
    var orderedCoefficients = new Array(maxExponent);
    ...
    for (var i = 0; i < orderedCoefficients.length; ++i) {
      orderedCoefficients[i] = orderedCoefficients[i] ? orderedCoefficients[i] : 0;
    }

    param.value = new Function_1.Function(orderedCoefficients.concat([0])); // no +c for now
  };

  Parser.prototype.polynomComponent = function (coefficient, name, exponent) {
    exponent.value = 1; // default to 1!

    coefficient.value = 1;

    if (this.isToken(Scanner_1.Token.Subtraction) || this.isToken(Scanner_1.Token.Number)) {
      this.term(coefficient);
    } else if (this.isToken(Scanner_1.Token.Identifier) && this._scanner.lookAhead() === Scanner_1.Token.LeftPar) {
      this.term(coefficient);
    }
    ...
    if (this.isToken(Scanner_1.Token.Exponential)) {
      this.consumeToken();
  ...
  Parser.prototype.additive = function (param) {
    var _a;

    var Operation = (_a = {}, _a[Scanner_1.Token.Multiplication] = StdLib_1.StdLib.Arithmetic.MULTIPLY, _a[Scanner_1.Token.Division] = StdLib_1.StdLib.Arithmetic.DIVIDE_BY, _a[Scanner_1.Token.Modulo] = StdLib_1.StdLib.Arithmetic.MODULO, _a);
    var op = undefined;
    var tmp = {
      value: 1
    };
    ...
    while (this.isToken(Scanner_1.Token.Multiplication) || this.isToken(Scanner_1.Token.Division) || this.isToken(Scanner_1.Token.Modulo)) {
      op = Operation[this._scanner.getCurrentToken()];
      this.consumeToken();
  ...
  Parser.prototype.multiplicative = function (param) {
    var name = "";

    switch (this._scanner.getCurrentToken()) {
      case Scanner_1.Token.Number:
      case Scanner_1.Token.Subtraction:
        this.number(param);
      ...
      case Scanner_1.Token.Identifier:
        var la = this._scanner.lookAhead();

        if (la === Scanner_1.Token.LeftPar || la === Scanner_1.Token.GenericBegin) {
  ...
  Parser.prototype.number = function (param) {
    var negate = false;
...
},{"./Scanner":"minimatica/Scanner.ts","./StdLib":"minimatica/StdLib.ts","./stdlib/Function":"minimatica/stdlib/Function.ts","./stdlib/Callable":"minimatica/stdlib/Callable.ts"}],"components/minimatica_editor/MinimaticaEditor.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/minimatica_editor/MinimaticaEditor.tsx":[function(require,module,exports) {
"use strict";
...
var Console_1 = require("../../minimatica/Console");

var MinimaticaText_1 = __importDefault(require("../minimatica_text/MinimaticaText"));

var MinimaticaConsole_1 = __importDefault(require("../minimatica_console/MinimaticaConsole"));

var Parser_1 = require("../../minimatica/Parser");

require("./MinimaticaEditor.sass");

var DEFAULT_SOURCE = "# function literals\n" + "var f1 := [x] -> x^(3) - 2x^(2) + x;\n" + "print(f1);\n" + "print(f1(3));\n" + "\n" + "# derive functions\n" + "var fder := derive(f1);\n" + "print(fder);\n" + "print(fder(3));\n" + "\n" + "# integrate functions\n" + "var fint := integrate(f1);\n" + "print(fint);\n" + "print(fint(3));\n" + "\n" + "# matrices\n" + "var mat1 := mat<2, 2>(1, 0, \n" + "                   0, 1);\n" + "var mat2 := mat<2, 2>(3, -2,\n" + "                      5,  1);\n" + "print(mat1);\n" + "print(mat1 * mat2);\n" + "\n" + "# basic math functions\n" + "print(fact(5)); # 5! = 120\n" + "print(binomial(10, 8)); # 10 choose 8\n" + "print(cos(90)); # cos(90) = 0 using degrees";

var MinimaticaEditor =
/** @class */
function (_super) {
  __extends(MinimaticaEditor, _super);

  function MinimaticaEditor() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
    ...
    _this.onSourceEdit = function (sourceText) {
      _this.setState({
        sourceText: sourceText
      });
    };

    _this.interpret = function () {
      _this.state.console.clear();

      var parser = new Parser_1.Parser(_this.state.sourceText, _this.state.console);
      parser.parse();

      _this.setState({
        runs: _this.state.runs + 1
      });
    };
  ...
  MinimaticaEditor.prototype.render = function () {
    var _a = this.state,
    ...
    return React.createElement("div", {
      className: "minimatica-editor"
    }, React.createElement(MinimaticaText_1.default, {
      sourceText: sourceText,
      onSourceEdit: this.onSourceEdit
    }), React.createElement("br", null), React.createElement("button", {
      onClick: this.interpret
    }, "Run"), React.createElement(MinimaticaConsole_1.default, {
      console: console
    }));
  };
...
exports["default"] = MinimaticaEditor;
},{"react":"../node_modules/react/index.js","../../minimatica/Console":"minimatica/Console.ts","../minimatica_text/MinimaticaText":"components/minimatica_text/MinimaticaText.tsx","../minimatica_console/MinimaticaConsole":"components/minimatica_console/MinimaticaConsole.tsx","../../minimatica/Parser":"minimatica/Parser.ts","./MinimaticaEditor.sass":"components/minimatica_editor/MinimaticaEditor.sass"}],"res/reference.json":[function(require,module,exports) {
module.exports = {
  "version": 1.0,
  "data": [{
    ...
    "content": [{
      "name": "Sine",
      "signature": "sin(op: number)",
      "description": "Returns the sine of <op> (in degrees)."
    }, {
      "name": "Cosine",
      "signature": "cos(op: number)",
      "description": "Returns the cosine of <op> (in degrees)."
    }, {
      "name": "Tangent",
      "signature": "tan(op: number)",
      "description": "Returns the tangent of <op> (in degrees)."
    }]
  }, {
    "category": "Function Lambdas",
    "content": [{
      "name": "Lambda Expressions",
      "signature": "[x] -> x^(3) - 5x",
      "description": "... is an exemplary lambda expression. The identifier within square brackets (here: <x>) is an inline parameter definition. It can be used with coefficients and exponents."
    }, {
      "name": "Function applications",
      "signature": "func(x)",
      "description": "... is an example application of <x> to the function denoted by <func>."
    }]
  }, {
    "category": "Calculus",
    "content": [{
      "name": "Integrate",
      "signature": "integrate(op: function)",
      "description": "Returns the indefinite integral of the function <op>."
    }, {
      "name": "Derive",
      "signature": "derive(op: function)",
      "description": "Returns the derivation of the function <op>."
    }]
  }, {
    "category": "Matrices and Vectors",
    "content": [{
      "name": "Matrix",
    ...
    "content": [{
      "name": "Factorial",
      "signature": "fact(op: number)",
      "description": "Returns the factorial of <op> (i. e. op!)."
    }, {
      "name": "Binomial",
      "signature": "binomial(n: number, k: number)",
      "description": "Returns the result of <n> choose <k>."
    }]
  }]
};
},{}],"components/minimatica_reference/MinimaticaReference.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/foldable_section/FoldableSection.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"react_utils.ts":[function(require,module,exports) {
"use strict";

exports.__esModule = true;

function withOptionalStyles(main) {
  var optionals = [];

  for (var _i = 1; _i < arguments.length; _i++) {
    optionals[_i - 1] = arguments[_i];
  }

  return [main].concat(optionals).join(" ");
}

exports.withOptionalStyles = withOptionalStyles;
},{}],"components/foldable_section/FoldableSection.tsx":[function(require,module,exports) {
"use strict";
...
require("./FoldableSection.sass");

var react_utils_1 = require("../../react_utils");

function FoldableSection(props) {
  ...
  return React.createElement("div", {
    className: react_utils_1.withOptionalStyles("foldable-section", expandedClass)
  }, React.createElement("h2", {
    onClick: onSelect
  }, header), React.createElement("div", {
    className: "foldable-section-content"
  }, children));
}

exports.FoldableSection = FoldableSection;
},{"react":"../node_modules/react/index.js","./FoldableSection.sass":"components/foldable_section/FoldableSection.sass","../../react_utils":"react_utils.ts"}],"components/foldable_section_item/FoldableSectionItem.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/foldable_section_item/FoldableSectionItem.tsx":[function(require,module,exports) {
"use strict";
...
require("./FoldableSectionItem.sass");

function FoldableSectionItem(props) {
  var name = props.name,
      signature = props.signature,
      description = props.description;
  return React.createElement("div", {
    className: "foldable-section-item"
  }, React.createElement("h3", null, name), React.createElement("pre", null, React.createElement("code", null, signature)), React.createElement("p", null, description));
}

exports.FoldableSectionItem = FoldableSectionItem;
},{"react":"../node_modules/react/index.js","./FoldableSectionItem.sass":"components/foldable_section_item/FoldableSectionItem.sass"}],"components/minimatica_reference/MinimaticaReference.tsx":[function(require,module,exports) {
"use strict";
...
var Reference = __importStar(require("../../res/reference.json"));

require("./MinimaticaReference.sass");

var FoldableSection_1 = require("../foldable_section/FoldableSection");

var FoldableSectionItem_1 = require("../foldable_section_item/FoldableSectionItem");

var MinimaticaReference =
/** @class */
function (_super) {
  __extends(MinimaticaReference, _super);

  function MinimaticaReference() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
    ...
    _this.switchSection = function (index) {
      _this.setState({
        expandedIndex: index
      });
    };
    ...
    _this.generateSectionItem = function (item) {
      return React.createElement(FoldableSectionItem_1.FoldableSectionItem, item);
    };
    /**
    ...
    _this.generateSection = function (section, index) {
      return React.createElement(FoldableSection_1.FoldableSection, {
        key: section.category,
        header: section.category,
        expanded: index == _this.state.expandedIndex,
        onSelect: function onSelect() {
          return _this.switchSection(index);
        }
      }, section.content.map(_this.generateSectionItem));
    };

    return _this;
  }

  MinimaticaReference.prototype.render = function () {
    var _this = this;

    var expandedIndex = this.state.expandedIndex;
    return React.createElement("div", {
      className: "foldable-section-list"
    }, Reference.data.map(function (section, currentIndex) {
      return _this.generateSection(section, currentIndex);
    }));
  };

  return MinimaticaReference;
}(React.Component);

exports["default"] = MinimaticaReference;
},{"react":"../node_modules/react/index.js","../../res/reference.json":"res/reference.json","./MinimaticaReference.sass":"components/minimatica_reference/MinimaticaReference.sass","../foldable_section/FoldableSection":"components/foldable_section/FoldableSection.tsx","../foldable_section_item/FoldableSectionItem":"components/foldable_section_item/FoldableSectionItem.tsx"}],"components/split_view/SplitView.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/split_view/SplitView.tsx":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  SplitView.prototype.render = function () {
    var _a = this.props,
        ...
        right = _a.right;
    return React.createElement("div", {
      className: "main--2-cols"
    }, React.createElement("section", null, left), React.createElement("section", null, right));
  };
...
},{"react":"../node_modules/react/index.js","./SplitView.sass":"components/split_view/SplitView.sass"}],"components/app/App.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/app/App.tsx":[function(require,module,exports) {
"use strict";
...
var MinimaticaEditor_1 = __importDefault(require("../minimatica_editor/MinimaticaEditor"));

var MinimaticaReference_1 = __importDefault(require("../minimatica_reference/MinimaticaReference"));

var SplitView_1 = __importDefault(require("../split_view/SplitView"));
...
function App() {
  ...
  }, React.createElement("h1", null, React.createElement("span", null, "M"), "ini", React.createElement("span", null, "M"), "atica"), React.createElement("p", null, "Minimatica is a minimalistic interpreted language for mathematical computations. It is open source and available on ", React.createElement("a", {
    href: "https://github.com/YourPsychiatrist/minimatica.git"
  }, "github.com"), ". You can run your scripts in the editor to the right and if you want to know what Minimatica is capable of, check out the reference to the left."))), React.createElement(SplitView_1.default, {
    left: React.createElement(MinimaticaReference_1.default, null),
    right: React.createElement(MinimaticaEditor_1.default, null)
  }));
}

exports.App = App;
},{"react":"../node_modules/react/index.js","../minimatica_editor/MinimaticaEditor":"components/minimatica_editor/MinimaticaEditor.tsx","../minimatica_reference/MinimaticaReference":"components/minimatica_reference/MinimaticaReference.tsx","../split_view/SplitView":"components/split_view/SplitView.tsx","./App.sass":"components/app/App.sass"}],"index.tsx":[function(require,module,exports) {
"use strict";
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./components/app/App":"components/app/App.tsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
